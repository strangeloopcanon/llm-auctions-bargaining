...
llm-live:
	PYTHONPATH=$(PYTHONPATH) $(UV) run python -m experiments.ip_completion_market.runner --provider codex --models gpt-5.4,gpt-5.2 --seeds 1 --firms 4 --modules 4 --products 2 --rounds 1 --codex-timeout 300 --output-dir runs_ip_completion_market/live_smoke
