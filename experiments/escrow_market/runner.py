...
from .generator import DEFAULT_DEADLINE_ROUND, generate_firms, generate_inventory_and_orders
from .market import run_escrow_market


def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Run the escrow market experiment.")
...
def main() -> None:
    ...
    output_path = out_dir / "escrow_market_results.jsonl"
    ...
    for offset in range(args.seeds):
        ...
        lots, orders = generate_inventory_and_orders(
            n_firms=args.firms,
            seed=seed,
        ...
        for model in models:
            for arm in arms:
                ...
                print(
                    f"Completed escrow market seed={seed} arm={arm} model={model} "
